---
title: "Sec-CH-Viewport-Height"
description: "Request header provides the client's layout viewport height in CSS pixels."
---

## General Summary

Request header provides the client's layout viewport height in CSS pixels.

## Detailed Description

The `Sec-CH-Viewport-Height` HTTP header is a specialized field used to request header provides the client's layout viewport height in CSS pixels. It acts as a signaling mechanism between the client and the server to enforce policies, negotiate capabilities, or provide telemetry data during the transmission of requests and responses.
...
```http
Sec-CH-Viewport-Height: <appropriate-value>
```

## Example

```http
Sec-CH-Viewport-Height: <value>
```
