...
description: "Response header that indicates that the server is willing to upgrade to a WebSocket connection."
---
...
```http
Sec-WebSocket-Accept: <appropriate-value>
```
